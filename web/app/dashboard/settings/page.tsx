...
/**
 * Settings — the workspace's account surface. Billing (plan, usage, invoices)
 * lives here now instead of a top-level nav item.
 */
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <h2 className="font-heading text-lg font-medium">Billing</h2>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <StatCard label="Videos" value={12} icon={Film} hint="of unlimited" />
          <StatCard
            label="Storage"
            value="4.2 GB"
            icon={HardDrive}
